<header class="bg-white px-6 shadow dark:bg-slate-900">
    ...
    >
        ...
        <div class="flex">
            ...
            {{--MENU PARA CUANDO NO ESTAS AUTENTIFICADO--}}
            @auth
                <div class="relative pt-1">
                    <button
                        id="toggle-login-menu"
                    ...
                    >
                        <img
                            ...
                            src="https://ui-avatars.com/api?name=Auth+A"
                            alt="Auth"
                        />
                    </button>
                    <div
            ...
            {{--MENU PARA CUANDO ESTAS AUTENTIFICADO--}}
            @guest
                <div class="relative pt-1">
                    <button
                        id="toggle-loged-menu"
                        class="ml-4 rounded-full text-slate-500 transition-colors hover:text-sky-500 focus:ring-2 focus:ring-slate-200 focus:ring-offset-1"
                    >
                        <img
                            class="h-6 w-6 rounded-full"
                            src="https://ui-avatars.com/api?name=Guest+E"
                            alt="guest"
                        />
                    </button>
                    <div
